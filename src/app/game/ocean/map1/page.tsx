...
import MCQCont, { MCQ } from '@/components/MCQ';
  ...
  return (
    <>
      ...
      <div className=" w-[85vw] mx-auto mt-16 mb-32">
        ...
        {storage?.score === 6 ? <p className="text-center mb-4">🎉 You won thegame!</p> : null}
        ...
        <div className="w-full max-w-[800px] relative mx-auto">
          ...
          <img className="w-full " src="/assets/map/1/map.jpg" />
        </div>
